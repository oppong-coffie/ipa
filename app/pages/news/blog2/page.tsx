      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 p-6 dark:bg-zinc-950 transition-colors duration-300">
        ...
        <div className="col-span-3 space-y-6">
          ...
          <div className="flex items-center gap-3">
            <Scale className="w-7 h-7 text-green-700 dark:text-green-500" />
          ...
          <div className="flex flex-col md:flex-row gap-4 items-start">
            ...
            {/* Text */}
            <div className="md:w-1/2 text-neutral-700 dark:text-zinc-400">
              <h2 className="text-xl font-semibold mb-2 flex items-center gap-2 dark:text-zinc-200">
                <Handshake className="w-5 h-5 text-green-700 dark:text-green-500" />
                Co-Creation & Respect 🌱
              </h2>
              <p>
                Recognizing, respecting, and integrating Indigenous and
                Traditional Knowledge (ITK) is not just beneficial—it&apos;s an
                ethical cornerstone of climate justice. Doing so upholds
                Indigenous Peoples&apos; rights to self-determination, cultural
                integrity, and participation in decisions affecting their lands
                and livelihoods.
              </p>
            </div>
          </div>
          ...
          <div className="text-neutral-700 dark:text-zinc-400 leading-relaxed space-y-4">
            <p>
              ...
              consultation toward
              <strong> true co-creation of solutions</strong> and shared
              leadership in climate governance. Communities must not only be
              heard—they must help design and own the outcomes.
            </p>

            <p>
              In northern Ghana, integrating Indigenous knowledge into climate
              strategies demands formal acknowledgment of ITK&opos;s validity
              alongside scientific approaches. It also means addressing
              entrenched <strong>power imbalances</strong> between local
              knowledge holders and external institutions.
            </p>

            <p>
              Processes should ensure{" "}
              <strong>Free, Prior, and Informed Consent (FPIC)</strong> and
              include mechanisms for equitable benefit-sharing and community
              ownership of knowledge. These principles are essential for
              fostering reciprocal partnerships and achieving inclusive, lasting
              climate justice. 🌿
            </p>

            <blockquote className="border-l-4 border-green-500 dark:border-green-600 pl-4 italic text-neutral-600 dark:text-zinc-500">
              “According to UNDP, Indigenous peoples—stewarding roughly 80% of
              global biodiversity— face increasing threats to their lives,
              livelihoods, and traditional knowledge under climate change.”
            </blockquote>
          </div>
          {/* Sub-images */}
          ...
          {/* Reference */}
          <div className="mt-6 border-t dark:border-zinc-800 pt-4 text-sm text-neutral-700 dark:text-zinc-400 space-y-2">
            <h3 className="font-semibold flex items-center gap-2 dark:text-zinc-200">
              <BookOpen className="w-4 h-4 text-green-700 dark:text-green-500" />
              Reference
            </h3>
            <p>
              Gorjestani, Nicolas. “Indigenous knowledge for development.” In{" "}
              <em>
