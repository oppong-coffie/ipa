      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-12 relative">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {reports.map((report, index) => (
            <motion.div
              ...
              className="relative bg-white rounded-2xl shadow-lg border border-yellow-100 overflow-hidden group"
            >
              {/* Card Header with Year */}
              <div className="bg-gradient-to-r from-[#8B7D6B] to-[#6B5D4B] px-6 py-4">
              ...
              {/* Card Body */}
              <div className="p-6">
                <h3 className="text-2xl font-bold text-[#8B7D6B] mb-2">
                  {report.label}
                </h3>
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="inline-flex items-center gap-3 bg-gradient-to-r from-[#8B7D6B] to-[#6B5D4B] hover:from-[#FDDC5C] hover:to-yellow-400 text-white hover:text-[#8B7D6B] px-6 py-3 rounded-xl font-semibold shadow-md transition-all duration-300 w-full justify-center"
                >
              ...
              <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-yellow-200/30 rounded-full blur-2xl group-hover:bg-yellow-300/40 transition-colors duration-300"></div>
            </motion.div>
          ))}
        </div>
        ...
        >
          ...
          <a
            ...
            className="text-[#8B7D6B] hover:text-[#FDDC5C] font-medium underline transition-colors"
          >
            contact us
          </a>
          .
